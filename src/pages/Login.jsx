...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    try {
      ...
      // Supabase initiates browser redirect to Google. Do not navigate or toast prematurely.
    } catch (err) {
    ...
    <div className="min-h-[80vh] flex items-center justify-center bg-neutral-light/30 px-4 py-12">
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-neutral-light w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-neutral mt-2">Log in to your ShopMate account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end text-sm mt-2">
            <button 
              ...
              disabled={loading}
              className="text-primary hover:underline font-medium disabled:opacity-70"
            >
              Forgot Password?
            </button>
          </div>
        ...
        <button
          ...
          className="w-full mt-6 bg-white border border-neutral-light text-neutral-dark py-2.5 rounded-lg font-medium hover:bg-neutral-light/30 transition-colors flex items-center justify-center gap-2 disabled:opacity-70 shadow-sm"
        >
          {googleLoading ? (
            <>
        ...
        <Link
          to="/login-otp"
          className="w-full mt-4 bg-white border border-neutral-light text-neutral-dark py-2.5 rounded-lg font-medium hover:bg-neutral-light/30 transition-colors flex items-center justify-center gap-2"
        >
